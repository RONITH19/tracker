...
const AboutSection = () => {
  return (
    <section className="py-24 bg-[#08121a] relative border-t border-white/5 scroll-mt-24" id="about">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto font-sans leading-relaxed">
            At Vikram GPS Tracker, we believe that peace of mind is not a luxury, but a fundamental right. 
